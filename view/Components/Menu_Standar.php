...
<div class="nav-wrapper grey darken-4">
      ...
      <a href="?c=Usuario&a=Inicio" class="text-logo"><b>UGB CENTRAL</b></a>
      <ul class="right hide-on-med-and-down">
        ...
        <li><a onclick="preguntar()" href="?c=User&a=LogoutUser" ><i class="material-icons">notifications_paused</i></a></li>
      </ul>
      </div>
</nav>
</div>
