...
<div class="row">
	  ...
	  <form method="POST" action="?c=Alumno&a=Agregar" enctype="multipart/form-data">
      ...
      <select class="browser-default" name="Carrera" id="Carrera" required>
        ...
        <?php foreach($this->model->CatalogoCarreras() as $j): ?>  
        <option value="<?php echo $j->Abreviatura; ?>"><?php echo $j->Nombre; ?></option>
        <?php endforeach; ?> 
