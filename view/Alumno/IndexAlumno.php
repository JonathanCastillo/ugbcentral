...
<div class="Container">
    ...
    <?php include 'view/Components/Menu_Alumno.php'; ?>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col s10">
            ...
            <?php foreach($this->model->InformacionPersonal($_SESSION['Codigo']) as $r): ?>  
                        
                <div class="col s3">    
                    <div class="card">
                    <input type="hidden" id="" name="">
                        <div class="card-image pulse">
                        <img class="materialboxed" height="400" src="<?php echo $r->Foto; ?>" >
